...
module.exports = function noMoreNocteniumLag(dispatch) {
    ...
    dispatch.hook('S_LOGIN', dispatch.majorPatchVersion < 86 ? 13 : 15, event => {
        gameId = event.gameId
        noctActive = false
        counter = {}
    })
    ...
    dispatch.hook('S_ABNORMALITY_BEGIN', 5, {filter: {silenced: null}}, event => {
    ...
    dispatch.hook('S_USER_STATUS', 4, event => {
